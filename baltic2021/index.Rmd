...
subtitle: "Exploring and visualizing your data using R<br>@ Baltic Summer School of Digital Humanities 2021"
output: 
  html_document: 
    number_sections: yes
    toc: yes
...
Please follow these instructions to download and install the necessary software and files. This will take some time, perhaps around 15-30min, depending on your prior familiarity with software installation and R.<br> 
...
<a href="https://raw.githubusercontent.com/andreskarjus/artofthefigure/master/baltic2021/dataviz_worksheet.zip" download target="_blank">click here to save the file</a> (if it doesn't work, you might need to right click and choose Save As or similar).

- It is a zipped/compressed file: unpack it into a convenient location - there's a single dataviz_worksheet.Rmd file in there (as illustrated below).
