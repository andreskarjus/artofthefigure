...
Welcome to the DH2019 workshop on Visualizing Your Data Using R.
...
- add subset(.$continent=="Europe") %>%  to the pipeline to view only European countries
...
cloud = data_corpus_inaugural$documents$texts %>% 
  ...
  ggplot(aes(x = rep(0,100), y=rep(0,100), 
    ...
    geom_text_repel(segment.size = 0, alpha=0.8) + 
...
Feel free to showcase your newly acquired skills on Twitter ;) - either with a link to an uploaded page or with a few screenshots. Tag @aRtoftheFigure and I'll happily retweet your creations.
...
If you want to stay updated keep an eye on my Twitter @AndresKarjus (for science content) and @aRtoftheFigure (for dataviz and workshop related stuff).
