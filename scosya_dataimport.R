## This contains some more examples of importing data, converting between wide and long format, adding matching coordinate values, and plotting.
...
dat_long = melt(dat_wide, measure.vars = 5:ncol(dat), value.name="rating") %>% separate(variable, c("agegroup", "location", "id"),  sep = "_"); rm(coln)
...
# Optional: examples of usage of the long format data
...
# Optional: examples of usage of the wide format data
