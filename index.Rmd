...
Click [here](https://andreskarjus.github.io/artofthefigure/preworkshop_summer.html) for the most recent (PPLS Writing Centre summer workshops) version of the preparation file. It will guide you through the installation of R, RStudio, the required packages, basically everything you'll need.

Here are the links to the various versions of the workshop script files.

- <a download href="https://raw.githubusercontent.com/andreskarjus/artofthefigure/master/artofthefigure_summer.Rmd">PPLS Writing Centre summer quantitative workshops</a>
