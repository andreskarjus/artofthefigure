...
Click [here](https://andreskarjus.github.io/artofthefigure/preworkshop_sgsss.html) for the most recent (SGSSS Summer School 2018) version of the preparation file. It will guide you through the installation of R, RStudio, and the required packages.
...
Note that if the script opens as a plain text file in your browser, you'll need to right-click it and choose "Save as..."; and make sure the saved file has the `.Rmd` extension, not a `.txt` extension. 
