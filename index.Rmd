...
This here functions as a cover page and record of all the *aRt of the Figure* workshops. Each iteration has had a slightly different structure, length and topic coverage - ranging from anything between short intros to programming, advanced dataviz and interactive graphs, data wrangling, and text/corpus linguistics. Besides standalone events, venues have included various summer schools, academic retreats, invited lectures, international conferences and hackathons, so far in 5 countries across Europe. All workshops are based on the [R](https://www.r-project.org/) language.
<br>As a humanities scholar myself, I specialize in helping humanities and social science folks with little to no coding experience get started with programming, which I see as the ultimate transferable skill - infinitely useful both for doing science and for those planning to move to industry, and in general for saving time on repetitive tasks and making one's life easier. 
<br>The focus of most of the workshops has been on data visualization. Why? Because (1) I believe data visualization is an integral component of doing science, and (2) it's more fun to learn programming when you can immedately see and interpret the results of your first coding attempts (and making pretty plots in R is very easy and intuitive, especially with packages like ggplot2).

If you have signed up to one of the workshops, you should have received an email ahead of time with instructions. If you are here because you signed up but did not get an email, contact the organizers to make sure you are registered.

<div style="text-align: right"> 
-- Andres Karjus, PhD<br>
[(personal website)](http://andreskarjus.github.io)<br>
[(personal/science twitter)](https://twitter.com/AndresKarjus)<br>
[(dataviz twitter)](https://twitter.com/artofdataviz)<br>
...
- Exploring and visualizing your data using R, a full-day workshop at the [Baltic Summer School of Digital Humanities 2021: Digital Methods in Humanities and Social Sciences](https://www.nlib.ee/et/digital-humanities-tallinn-2021) (August 2021). Pre-workshop installation instructions and materials are [here](https://andreskarjus.github.io/artofthefigure/baltic2021).

**Future**

- Will be teaching more dataviz and text analytics in the Cultural Data Analytics II course at Tallinn University in fall 2021.

**Recent past**

- ~~Tartu Summer School of Semiotics, Semiotic horizons: time, memory and future(s); August 2021~~ invited, but event was corona-cancelled
- Gave a dataviz and text analytics lecture and workshop in the Cultural Data Analytics I course at Tallinn University (April 2021).
- Gave two guest workshops on dataviz in the "Data science and digital humanities" (Andmeteadus ja digihumanitaaria) fall semester course at Tartu University.
...
- ~~The Summer School of Linguistics, Czech Republic, August 2020~~ invited, but event event was corona-cancelled
...
- Attractive, Interactive, Ready for the Web: Visualizing Your Data Using R. Workshop at the International Corpus Linguistics Conference 2019, Cardiff, Wales; July 2019 | [See here ](https://andreskarjus.github.io/artofthefigure/cl2019) for the dedicated website with links for downloading the software, and all the scripts.
...
- Jupyter Notebooks taster, SGSSS Summer School 2019; Scotland (co-teaching; not R; but included examples from the inter-language ``plotly`` package which has been used here a lot, see examples below)
- Introduction to data exploration and visualization with R. Workshop at the PPLS LEL Spring Retreat to Firbush, Scotland; May 2019 | [Installation instructions](https://andreskarjus.github.io/artofthefigure/preworkshop_firbush2.html)  | <a download href="https://raw.githubusercontent.com/andreskarjus/artofthefigure/master/artofthefigure_firbush2.Rmd">script</a>
...
- University of Edinburgh PPLS Writing Centre short workshops for 2017-2018
- Teaching in earlier years: courses at the University of Tartu 2014-2016; a workshop at the Academia Salensis summer school, Lithuania 2015.
