...
subtitle: "Online workshop for the Edinburgh CDCS"
author: "Instructor: Andres Karjus http://andreskarjus.github.com"
output: 
  html_document: 
    toc: true
    toc_float: true
...
- Some exercises mention discussing the plots with a friend or neighbour - this mainly applies to the live versions of this workshop, but if you happen to be doing this online together with a friend, do discuss your results.
...
### Exercises:
- Add theme_minimal() or theme_classic() or theme_dark() for different themes and grids
