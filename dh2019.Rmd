...
It is vital that all participants complete the steps to install the software and download necessary files before the workshop. 
We only have half a day, so we can't afford to waste any time on installation issues once the workshop has started.

[Click here](https://andreskarjus.github.io/artofthefigure/preworkshop_dh2019.html) to view and complete the instructions.
