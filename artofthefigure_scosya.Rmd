...
- Coloring by groups is doable in base graphics, but even easier with ggplot2. Add ` ccolor=agegroup117 `to the `aes()` above.
...
```{r, eval=FALSE, echo=FALSE, message=F, warning=F, fig.width="100%"}
